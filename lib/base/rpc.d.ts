...
export declare const getBlockTransactionCount: {
    name: string;
    call: (args: any) => "getBlockTransactionCountByHash" | "getBlockTransactionCountByNumber";
    params: number;
    inputFormatter: any[];
    outputFormatter: any;
};
export declare const getTransaction: {
    ...
    params: number;
    inputFormatter: null[];
    outputFormatter: (rpcTx: outputFormatter.RPC.getTransactionResult) => {
...
export declare const signTransaction: {
    ...
    call: string;
    params: number;
    inputFormatter: (({ from, privateKey, data, nonce, quota, validUntilBlock, value, version, chainId, to, }: {
        from: string;
        privateKey: string;
